<?php
/*
 * Unicode-wp-theme Navwalker
 *
 * @package unicode-wp-theme
 */
if ( ! class_exists( 'unicodeBrand_nav_blackBar' ) ) {
	class unicodeBrand_nav_blackBar extends Walker_Nav_Menu {
...
if ( ! class_exists( 'unicodeBrand_nav_globalMenu' ) ) {
	class unicodeBrand_nav_globalMenu extends Walker_Nav_Menu {
...
if ( ! class_exists( 'unicodeBrand_nav_primary' ) ) {
	class unicodeBrand_nav_primary extends Walker_Nav_Menu {
...
if ( ! class_exists( 'unicodeBrand_nav_sidenav' ) ) {
	class unicodeBrand_nav_sidenav extends Walker_Nav_Menu {
...
if ( ! class_exists( 'unicodeBrand_nav_footerSocial' ) ) {
	class unicodeBrand_nav_footerSocial extends Walker_Nav_Menu {
