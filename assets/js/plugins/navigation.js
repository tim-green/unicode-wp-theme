document.addEventListener('DOMContentLoaded', () => {
    ...
    if ($navbarBurgers.length > 0) {
      ...
      $navbarBurgers.forEach((el) => {
        el.addEventListener('click', () => {
          ...
          const $navBar = document.querySelector('.unicode-navbar-white')
          const $button = document.querySelector('.unicode-navbar-black>.navbar-end')
    ...
    window.addEventListener('resize', ()=>{
      ...
      const navbarWhite = document.querySelector('.unicode-navbar-white')
      const blackNav = document.querySelector('.unicode-navbar-black')
      if (width >= 1024) {
